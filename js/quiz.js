...
function init(){
	...
	sessionStorage.setItem('a9','c');//last two questions
	sessionStorage.setItem('a10','b');
	//No need to change the "a1" column unless you are adding more questions...
	//The answers to the multiple choice questions are as follows... so question 1 is d...2 is d...so on
}
